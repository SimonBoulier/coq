...
type nonrec vernac_expr =
  ...
  | VernacInductive of vernac_cumulative option * Decl_kinds.private_flag * inductive_flag *
      (inductive_expr * decl_notation list) list * (fixpoint_expr * decl_notation list) list
