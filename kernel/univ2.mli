...
(** Lt(n) represents i <= j + n *)
type constraint_type = Le of int | Eq
type univ_constraint = universe_level * constraint_type * universe_level

val le : constraint_type
val lt : constraint_type
...
val enforce_leq_n : int -> universe constraint_function
val enforce_leq : universe constraint_function
val enforce_eq_level : universe_level constraint_function
val enforce_leq_level_n : int -> universe_level constraint_function
